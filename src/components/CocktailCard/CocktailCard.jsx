...
export const CocktailCard = ({ mainDrinksPage, id }) => {
      ...
      <div className={css.drink_card}>
        ...
        {mainDrinksPage ? (
          <div className={css.main_drink_info}>
            <h2 className={css.main_drink_title}>{obj.drink}</h2>
          ...
          <div className={css.additional_drink_info}>
            <div className={css.additional_drink_details}>
              ...
              <p className={css.additional_drink_alc}>{obj.alcoholic}</p>
              <p className={css.additional_drink_description}>
                {obj.description}
              </p>
            </div>
